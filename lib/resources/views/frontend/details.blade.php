			...
			<div id="product-info">
				...
				<div class="row">
					<div id="product-img" class="col-xs-12 col-sm-12 col-md-3 text-center">
						<img width="230px" src="{{asset('lib/storage/app/avatar/'.$item->prod_img)}}">
					</div>
					<div id="product-details" class="col-xs-12 col-sm-12 col-md-9">
						<p>Giá: <span class="price">{{$item->prod_price,0,',','.'}} VND</span></p>
						...
						<p>Trạng thái: @if($item->prod_status==1) Còn hàng @else Hết hàng  @endif</p>
