					...
					<div id="search" class="col-md-7 col-sm-12 col-xs-12">
						<div class="input-group">
							<div class="input-group-btn">
								<input type="text" name="result" placeholder="PRODUCT" class="form-control">
							</div>
							<div class="input-group-btn">
								{{-- <button class="btn btn-info" type="submit" name="submit"><span class="glyphicon glyphicon-search"></span></button> --}}
