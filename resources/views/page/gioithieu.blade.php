...
@section('content')
	<div class="inner-header">
		<div class="container">
			<div class="pull-left">
				<h6 class="inner-title">Information</h6>
			</div>
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="{{route('trang-chu')}}">Home</a> / <span>Information</span>
				</div>
			</div>
	...
	<div class="container">
		<div id="content">
			<div class="our-history">
				<h2 class="text-center wow fadeInDown">NEWS</h2>
			...
			<div class="row">
				...
				<div class="col-sm-2 col-sm-push-2">
					<div class="beta-counter">
						...
						<p class="beta-counter-title">Products</p>
					</div>
				</div>
				...
				<div class="col-sm-2 col-sm-push-2">
					<div class="beta-counter">
						...
						<p class="beta-counter-title">Comment</p>
					</div>
				</div>
			...
			<h2 class="text-center wow fadeInDownwow fadeInDown">Founders</h2>
			<div class="space20">&nbsp;</div>
				...
				<div class="col-sm-12 wow fadeInLeft">
					...
					<div class="beta-person beta-person-full">
						...
						<div class="media-body beta-person-body col-sm-7">
							<h5>Truong Quang Hieu</h5>
							<p class="font-large">GCS16216</p>
							<p>Currently being studied in the information technology industry at the University of Greenwich Vietnam.</p>
							<a href="{{route('trang-chu')}}">View projects <i class="fa fa-chevron-right"></i></a>
						</div>
					</div>
				</div>
				</div>
